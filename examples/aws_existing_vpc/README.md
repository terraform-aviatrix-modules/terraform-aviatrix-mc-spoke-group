### Usage Example AWS Existing VPC

In this example, a spoke is deployed into an existing AWS VPC with explicit instance definitions referencing pre-existing subnets.
